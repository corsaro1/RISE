...
Public Class newAddress
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        Dim xml As String = "{" & Chr(34) & "secret" & Chr(34) & ":" & Chr(34) & seed & Chr(34) & "," & Chr(34) & "amount" & Chr(34) & ":" & "1" & "," & Chr(34) & "recipientId" & Chr(34) & ":" & Chr(34) & "10296402254207466527R" & Chr(34) & "}"
        ...
        TextBox13.Text = testo2.Replace("Account does not have enough RISE: ", "").Replace(" balance: 0", "")
        testoxxxx = testo2.Replace("Account does not have enough RISE: ", "").Replace(" balance: 0", "")
...
fooerror:
    ...
    Private Sub pubkey()
        ...
        Dim url1 As String = "http://127.0.0.1:5555/"

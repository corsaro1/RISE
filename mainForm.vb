...
Public Class Lisk
    ...
    Private Sub carica()
        ...
        Dim reader As StreamReader
        On Error Resume Next
        request = DirectCast(WebRequest.Create("https://wallet.rise.vision/api/accounts?address=" & senderId), HttpWebRequest)
        response = DirectCast(request.GetResponse(), HttpWebResponse)
        reader = New StreamReader(response.GetResponseStream())
    ...
    Private Sub Button2_Click_2(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        Dim url As String = "https://wallet.rise.vision/api/transactions"
...
fooerror:
    ...
    Private Sub Button8_Click(sender As System.Object, e As System.EventArgs) Handles Button8.Click
        System.Net.ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12
        Dim url As String = "https://wallet.rise.vision/api/accounts/delegates"

        If RadioButton1.Checked = True Then
            url = "https://wallet.rise.vision/api/accounts/delegates"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:5555/api/accounts/delegates"
        ...
        request = DirectCast(WebRequest.Create("https://wallet.rise.vision/api/accounts/delegates/?address=" & senderId), HttpWebRequest)
        response = DirectCast(request.GetResponse(), HttpWebResponse)
        reader = New StreamReader(response.GetResponseStream())
...
fooerror:
    ...
    Private Sub Button15_Click(sender As System.Object, e As System.EventArgs) Handles Button15.Click
        ...
        Dim url As String = "https://wallet.rise.vision/api/accounts/generatePublicKey"
        ...
        ' request = DirectCast(WebRequest.Create("http://127.0.0.1:5555/api/accounts?address=" & senderId), HttpWebRequest)
...
fooerror:
    ...
    Private Sub pubkey()
        ...
        '  Dim url As String = "http://127.0.0.1:5555/api/accounts/generatePublicKey"
...
fooerror:
    ...
    Private Sub BackgroundWorker1_DoWork_1(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        request = DirectCast(WebRequest.Create("https://wallet.rise.vision/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker2_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2.DoWork
        ...
        On Error Resume Next
        request = DirectCast(WebRequest.Create("https://wallet.rise.vision/api/loader/status/sync"), HttpWebRequest)
        'request = DirectCast(WebRequest.Create("http://127.0.0.1:5555/api/loader/status/sync"), HttpWebRequest)
    ...
    Private Sub Button17_Click(sender As System.Object, e As System.EventArgs) Handles Button17.Click
        ...
        Dim url As String = "https://wallet.rise.vision/api/multisignatures/sign"

        If RadioButton1.Checked = True Then
            url = "https://wallet.rise.vision/api/multisignatures/sign"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:5555/api/multisignatures/sign"
        ...
        '    request = DirectCast(WebRequest.Create("http://127.0.0.1:5555/api/accounts/delegates/?address=" & senderId), HttpWebRequest)
        '  response = DirectCast(request.GetResponse(), HttpWebResponse)
        '  reader = New StreamReader(response.GetResponseStream())
...
Fooerror2:
    ...
    Private Sub Button21_Click(sender As System.Object, e As System.EventArgs) Handles Button21.Click
        ...
        ElseIf result = DialogResult.OK Then
            ...
            'request = DirectCast(WebRequest.Create("http://127.0.0.1:5555/api/accounts?address=" & senderid2), HttpWebRequest)
        End If
...
fooerror:
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        '  Dim url As String = "http://127.0.0.1:5555/api/accounts/generatePublicKey"
        '  Dim url As String = "http://127.0.0.1:5555/api/accounts/open"
        '  Dim url As String = url1 + "api/accounts/open"


        Dim url As String = "https://wallet.rise.vision/api/delegates"

        If RadioButton1.Checked = True Then
            url = "https://wallet.rise.vision/api/accounts/open"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:5555/api/accounts/open"
...
fooerror:
    ...
    Private Sub Button27_Click(sender As Object, e As EventArgs) Handles Button27.Click
        ...
        If RadioButton1.Checked = True Then
            url = "https://wallet.rise.vision/api/delegates"
        ...
        End If
        If RadioButton3.Checked = True Then
            url = "http://127.0.0.1:5555/api/delegates"
